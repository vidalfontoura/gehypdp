...
import edu.ufpr.grammar.memento.Memento;
...
public abstract class AbstractGrammarMapper<T> {
	...
	public boolean loadGrammar(String grammarFilePath) {
		...
		InputStream resourceAsStream = AbstractGrammarMapper.class.getResourceAsStream(grammarFilePath);
		return loadGrammar(resourceAsStream);
	}

	public boolean loadGrammar(InputStream grammarFile) {
